  ...
  <BasePage class="flex flex-col items-center justify-center gap-5 text-white ">
    <template v-slot:body>
      ...
      <div class="w-full h-full col-span-1">
        <div>
          <h1 class="font-[400] text-2xl leading-10 m-auto pb-2 -tracking-tighter">Liên hệ với chúng tôi..</h1>
        </div>
        <div class="flex items-center justify-between gap-3 mb-3">
          <img src="../../assets/images/default.png" alt="Ảnh đại diện" class="w-[50px] h-[50px] object-cover rounded-full mr-2 ml-5">
          <p class="px-4 py-2 border-2 border-gray-200 border-solid rounded-md" :class="success ? 'text-green-500' : ''">
            {{
              success ? "Hi, I’m Amanda. Chúng tôi sẽ liên hệ trong thời gian sớm nhất" : "Hi, I’m Amanda. Need help? Use the form below or email me at hello@california_golfclub.org."
            }}
          </p>
        </div>
        <form class="w-full ">
          ...
          <div class="flex flex-col w-full gap-2">
            ...
            <div class="mb-4">
              ...
              <Input
                ...
                :classChild="v$.email.$error && error.emailError == true ? 'border-[2px] border-red-600 border-solid' : 'border-transparent'"
              />
