...
public class DatetimeConvertFormat {
   ...
   * @return Date
   */
  public static Date getDateByNumericInput(final int year, final int month, final int day) {
   ...
   */
  public static String convertDateToStringWithFormat(@NonNull final String pattern,
                                                     final Date date) {
  ...
  public static Date convertStringToDateWithFormat(final String date) {
    ...
    calendar
        .set(Integer.parseInt(dates[2]), Integer.parseInt(dates[1]), Integer.parseInt(dates[0]));
